    ...
    public partial class FormTarefasPendentes : Form
    {
        ...
        private void FormTarefasPendentes_Load(object sender, EventArgs e) 
        {
            ...
            foreach (Tarefa Dados in DadosTarefa.Tarefas)
            {
                ...
                {
                FlowLayoutPanel ReceberTarefas = new FlowLayoutPanel();  //Um flow layout painel tem diferença do painel normal pois é melhor para deixar mais bonito 
                ...
                Informacoes.Font = new Font ("Arial", 15, FontStyle.Bold ); //Aumentar o texto, fonte e talz do layoutpainel ja que nao da pra mudar no desing direto
                ...
                Verificar.AutoSize = true; // Deixar o negocio mais espaçado
                Verificar.Font = new Font("Arial", 15, FontStyle.Regular);// Aumentar o texto da checkbox 
